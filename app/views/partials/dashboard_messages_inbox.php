<!-- INBOX -->
<div class="tab-content no-border no-padding" id="inbox">
		...
		<div class="message-container">
			...
			<div class="message-list-container">
				<div class="message-list" id="message-list">
					...
					<div ng-show="messages && messages.Inbox === undefined">
						<p class="text-center"><?= trans('general.no_messages'); ?></p>
					</div>

					<table id="sample-table-1"
						   class="table table-striped table-bordered table-hover"
						   ng-hide="messages && messages.Inbox === undefined">
						<thead>
							<tr>
								<th class="center">
									<label>
						...
						<tbody>
							<tr ng-repeat="message in messages.Inbox | orderBy:predicate:reverse"
								ng-class="{'blue': message.status == 'New', 'odd': !$index % 2 == 0, 'even': $index % 2 == 0}">
								<td class="center">
									<label>
										<input type="checkbox"
											   class="ace"
								...
								<td ng-click="showMore(message, true)">
									{{message.message |
								...
								<td>
									<? include(PARTIALS_DIR . '/dashboard_messages_buttons_inbox.php'); ?>
								</td>
							</tr>
