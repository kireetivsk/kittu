<!-- SENT -->
<div class="tab-content no-border no-padding" id="sent">
		...
		<div class="message-container">
			...
			<div class="message-list-container">
				<div class="message-list" id="message-list">
					...
					<div ng-show="messages && messages.Sent === undefined">
						<p class="text-center"><?= trans('general.no_messages'); ?></p>
					</div>

					<table id="sample-table-1"
						   class="table table-striped table-bordered table-hover"
						   ng-hide="messages && messages.Sent === undefined">
						<thead>
							<tr>
								<th class="center">
									<label>
								...
								<th ng-click="predicate = 'to'; reverse=!reverse"
									class="pointer">
						...
						<tbody>
							<tr ng-repeat="message in messages.Sent | orderBy:predicate:reverse">
								<td class="center">
									<label>
										<input type="checkbox"
											   class="ace"
								...
								<td>
									<? include(PARTIALS_DIR . '/dashboard_messages_buttons_sent.php'); ?>
								</td>
							</tr>
