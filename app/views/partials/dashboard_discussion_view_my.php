<div class="row">
	<div class="col-xs-12 widget-container-span">
		<!--category group-->
		<div class="widget-box discussion">
			...
			<div class="widget-body">
				<div class="widget-main row">
					<div id="my_discussions"
						 class="accordion-style1 panel-group" ng-class="myShowPosts == true ? 'col-md-4' : 'col-xs-12'">
						<!--categories-->
										...
										<div class="widget-main topic-body">
											<div class="accordion-style1 panel-group"
												...
												<div class="panel panel-default"
													 ng-click="topicClick(topic, 'my'); topic.new_count = 0"
													 ng-class="my_topic.id == topic.id ? 'topic-selected' : ''">
					...
					<!--posts section-->
					<div class="col-md-8" ng-show="myShowPosts">
						<!--post header-->
						<div class="row">
							<div class="col-xs-12">
								<h5><?= trans('general.posts_in');?> {{my_topic.title}}</h5>
								<div>
									<button class="btn btn-danger btn-sm"
											ng-click="closePosts('my')">
										<?= trans('general.close');?>
									</button>
						...
						<!--no post message-->
						<div ng-hide="my_topic.discussion_post">
							<h4><?= trans('general.no_posts');?></h4>
						</div>
						<!--posts-->
						<div class="row">
							<div class="col-xs-12" ng-repeat="post in my_topic.discussion_post">
								<div class="post-body">
												...
												<div class="row">
													<div class="col-xs-12">
														...
														<i class="red icon-trash pointer"
														   ng-click="deletePost(post, $index, 'my')"
										...
										<div class="col-xs-8 col-md-10">
											...
											<div>
												...
												<button class="btn btn-info btn-sm"
														...
														ng-click="editPost(post, $index, 'my'); show_edit_post = false"
											...
											<div class="row comment-spacer"
												...
												<div class="col-xs-8 col-sm-10"
													...
													<p>
														{{comment.content}}
														<span class="close"
															  ng-click="deleteComment(comment, $parent.$index, $index, 'my')">
