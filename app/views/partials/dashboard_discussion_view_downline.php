			...
			<div class="widget-body">
				<div class="widget-main row">
					<div id="my_discussions"
						 class="accordion-style1 panel-group" ng-class="downShowPosts == true ? 'col-md-4' : 'col-xs-12'">
						<!--categories-->
										...
										<div class="widget-main topic-body">
											<div class="accordion-style1 panel-group"
												...
												<div class="panel panel-default"
													 ng-click="topicClick(topic, 'down'); topic.new_count = 0"
													 ng-class="down_topic.id == topic.id ? 'topic-selected' : ''">
					...
					<!--posts section-->
					<div class="col-md-8" ng-show="downShowPosts">
						<!--post header-->
						<div class="row">
							<div class="col-xs-12">
								<h5><?= trans('general.posts_in');?> {{down_topic.title}}</h5>
								<div>
									<button class="btn btn-danger btn-sm"
											ng-click="closePosts('down')">
										<?= trans('general.close');?>
									</button>
						...
						<!--no post message-->
						<div ng-hide="down_topic.discussion_post">
							<h4><?= trans('general.no_posts');?></h4>
						</div>
						<!--posts-->
						<div class="row">
							<div class="col-xs-12" ng-repeat="post in down_topic.discussion_post">
								<div class="post-body">
												...
												<div class="row" ng-show="user.id == post.owner.user_id">
													<div class="col-xs-12">
														...
														<i class="red icon-trash pointer"
														   ng-click="deletePost(post, $index, 'down')"
										...
										<div class="col-xs-8 col-md-10">
											...
											<div>
												...
												<button class="btn btn-info btn-sm"
														...
														ng-click="editPost(post, $index, 'down'); show_edit_post = false"
										...
										<div class="col-xs-12">
											...
											<div class="row comment-spacer"
												...
												<p>
													{{comment.content}}
													<span class="close"
														  ng-click="deleteComment(comment, $parent.$index, $index, 'down')"
