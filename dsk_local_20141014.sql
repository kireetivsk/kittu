CREATE DATABASE  IF NOT EXISTS `dsk_1` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `dsk_1`;
...
CREATE TABLE `company_user` (
  ...
  CONSTRAINT `company_user_map_company_id` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `company_user_map_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `company_user` VALUES (1,80),(1,99),(1,100),(1,101),(1,102),(1,103),(1,105);
...
INSERT INTO `meta_profile_types` VALUES (1,'display_name',NULL,'',1,'consultant',1000),(2,'avatar_path',NULL,'',1,'consultant',2000),(3,'location',NULL,'',1,'consultant',3000),(4,'url',NULL,'',1,'consultant',4000),(5,'social','json encoded array of social_id:url pairs','',1,'consultant',5000),(6,'phone',NULL,'',1,'consultant',6000),(7,'company_rank','json encoded array of company_id:name pairs','',1,'consultant',7000);
...
CREATE TABLE `meta_setting_types` (
  ...
  `setting_type` enum('user','company') NOT NULL DEFAULT 'user',
  `ordinal` int(11) NOT NULL DEFAULT '1000',
  PRIMARY KEY (`id`),
...
INSERT INTO `meta_setting_types` VALUES (1,'Last selected company','last_company','The last company a user selected. An integer of the company id last selected','',1,'user',1000),(2,'Incoming connection requests permissions','incoming_connection_requests_permissions','How to handle incomming connection requests. Options: approve_all, verify_upline, verify_downline, v','verify_all',2,'user',2000);
...
INSERT INTO `meta_social_networks` VALUES (1,'Facebook',NULL,10),(2,'Twitter',NULL,20),(3,'Instagram',NULL,30),(4,'Vine',NULL,40),(5,'Pinterest',NULL,50);
...
-- Dump completed on 2014-10-14 17:05:15
